...
- secret_or_pii: 0
- workflow_tool_traces: 0
- binary_metadata_or_path_traces: 0
- author_metadata_alignment: PASS
- dependency_scope: project-specific manifests only; no global package freeze
